...
func (cnf *config) getPokemon(wantedPokemon string) (Pokemon, error) {
	baseUrl := "https://pokeapi.co/api/v2/pokemon/" + wantedPokemon
	var pokemon Pokemon
	if val, ok := cnf.Cache.Get(baseUrl); ok {
		fmt.Println("getting entrys for an pokemon")
